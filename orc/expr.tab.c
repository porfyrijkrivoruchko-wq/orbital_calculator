...
{
  "\"end of file\"", "error", "\"invalid token\"", "UNIT", "CONST", "'+'",
  "'-'", "'*'", "'/'", "NEG", "'^'", "'('", "')'", "$accept", "value",
  "expr", YY_NULLPTR
};
...
{
      35,    -6,    35,    35,    14,    16,    -5,    22,    -6,    30,
      -6,    35,    35,    35,    35,    35,    -6,    -6,    -4,    -4,
      -5,    -5,    -5
};
...
{
       0,    11,     0,     0,     0,     0,     4,     0,     1,     0,
       2,     0,     0,     0,     0,     0,    10,     3,     5,     6,
       7,     8,     9
};
...
{
       6,     7,     9,    13,    14,    15,    15,     0,     0,    18,
      19,    20,    21,    22,     8,     0,     0,     0,     1,    10,
       2,    11,    12,    13,    14,     3,    15,    11,    12,    13,
      14,     0,    15,    17,    16,    11,    12,    13,    14,     1,
      15,     2,     0,     0,     0,     0,     3
};

static const yytype_int8 yycheck[] =
{
       2,     3,     4,     7,     8,    10,    10,    -1,    -1,    11,
      12,    13,    14,    15,     0,    -1,    -1,    -1,     4,     3,
       6,     5,     6,     7,     8,    11,    10,     5,     6,     7,
       8,    -1,    10,     3,    12,     5,     6,     7,     8,     4,
      10,     6,    -1,    -1,    -1,    -1,    11
};
...
{
       0,     4,     6,    11,    14,    15,    15,    15,     0,    15,
       3,     5,     6,     7,     8,    10,    12,     3,    15,    15,
      15,    15,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* value: expr UNIT  */
#line 29 "expr.y"
            { parse_result=yyval=yyvsp[-1]*yyvsp[0]; }
#line 1136 "expr.tab.c"
    break;

  case 3: /* value: value expr UNIT  */
#line 30 "expr.y"
                  { parse_result=yyval=yyvsp[-2]+yyvsp[-1]*yyvsp[0]; }
